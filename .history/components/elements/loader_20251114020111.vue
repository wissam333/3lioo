    ...
    >
      ...
      <div class="loader-content">
        ...
        <div class="security-terminal-loader">
          ...
          <div class="terminal-body">
            ...
            <div class="terminal-line output">
              <span class="success-text">✓</span> Loading threat intelligence database
            </div>
            <div class="terminal-line">
        ...
        <div class="status-messages">
          <div class="status-item" :class="{ active: currentStatus === 0 }">
            <span class="status-icon">⟫</span>
            Initializing security protocols...
          </div>
          <div class="status-item" :class="{ active: currentStatus === 1 }">
            <span class="status-icon">⟫</span>
            Loading threat intelligence...
          </div>
          <div class="status-item" :class="{ active: currentStatus === 2 }">
            <span class="status-icon">⟫</span>
            Establishing encrypted connection...
          </div>
          <div class="status-item" :class="{ active: currentStatus === 3 }">
            <span class="status-icon">⟫</span>
        ...
        <div class="encryption-badge">
          ...
          <div class="badge-text">
            ...
            <div class="badge-subtext">AES-256 Encrypted</div>
          </div>
        </div>
      </div>
    </div>
