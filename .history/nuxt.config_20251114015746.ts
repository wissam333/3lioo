...
export default defineNuxtConfig({
  ...
  target: "static", // for Nuxt 3 SSG
  nitro: {
    prerender: {
      crawlLinks: true, // automatically pre-render discovered links
      routes: getBlogRoutes(), // your dynamic blog routes
    },
  },
  content: {
    ...
    // Where your content lives (same as Decap CMS config)
    sources: {
      content: {
        driver: "fs",
        base: "/content",
