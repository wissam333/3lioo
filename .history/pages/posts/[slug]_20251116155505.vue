  ...
  <div v-if="post" class="article-page">
    ...
    <main class="content">
      ...
      <header class="article-header">
        ...
        <!-- Excerpt -->
        <div v-if="post.description" class="article-excerpt">
...
const content = ref(null); // Now this will reference the article content container
...
const extractHeadings = () => {
  ...
  // Wait a bit for the ContentRenderer to finish rendering
  setTimeout(() => {
    ...
    // Setup observer after extracting headings
