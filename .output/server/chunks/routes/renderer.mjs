...
import { f as buildAssetsURL, u as useRuntimeConfig, g as getResponseStatusText, h as getResponseStatus, i as defineRenderHandler, p as publicAssetsURL, j as getQuery, e as createError, k as getRouteRules, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Ugarit Center"}],"link":[{"rel":"icon","href":"/logo/bluelogo.png","type":"image/x-icon"},{"rel":"preconnect","href":"https://3lioo.netlify.app","crossorigin":""}],"style":[],"script":[],"noscript":[],"title":"3lioo Blog","htmlAttrs":{"lang":"en"}};
