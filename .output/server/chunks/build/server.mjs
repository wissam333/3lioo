...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "debug",
    path: "/debug",
    component: () => import('./debug.vue.mjs')
  },
  {
    name: "index",
    path: "/",
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-34155864>`);
      if (unref(data).show) {
        _push(`<div class="${ssrRenderClass([{ "loader-visible": unref(data).show }, "cyber-loader"])}" data-v-34155864><div class="cyber-grid-bg" data-v-34155864></div><div class="scan-line" data-v-34155864></div><div class="loader-content" data-v-34155864><div class="cyber-spinner" data-v-34155864><div class="spinner-ring" data-v-34155864></div><div class="spinner-ring" data-v-34155864></div><div class="spinner-ring" data-v-34155864></div><div class="spinner-core" data-v-34155864><div class="spinner-dot" data-v-34155864></div></div></div><div class="terminal-line" data-v-34155864><div class="progress-container" data-v-34155864><div class="progress-bar" style="${ssrRenderStyle({ width: unref(data).percent + "%" })}" data-v-34155864></div><div class="progress-text" data-v-34155864>${ssrInterpolate(unref(data).percent)}%</div></div></div><div class="encryption-badge" data-v-34155864><div class="badge-icon" data-v-34155864>🔒</div><div class="badge-text" data-v-34155864><div data-v-34155864>SECURE CONNECTION</div><div class="badge-subtext" data-v-34155864>AES-256 Encrypted</div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-34155864"]]);
...
export { _export_sfc as _, useSeoMeta as a, useRequestFetch as b, useRoute as c, useRouter as d, useNuxtApp as e, fetchDefaults as f, useRuntimeConfig as g, hasProtocol as h, withoutTrailingSlash as i, joinURL as j, nuxtLinkDefaults as k, useAppConfig as l, asyncDataDefaults as m, navigateTo as n, createError as o, parseQuery as p, useI18n as q, resolveRouteObject$1 as r, server as s, useHead as u, withTrailingSlash as w };
